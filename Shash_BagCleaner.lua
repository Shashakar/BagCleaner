...
local function shouldDeleteItem(quality, vendorValue)
    return quality == 0 and vendorValue > 0 and vendorValue <= DELETE_LIMIT
end
    ...
    for bag = 0, 4 do
        for slot = 1, GetContainerNumSlots(bag) do
            ...
            if itemLink then
                ...
                if quality and vendorPrice and shouldDeleteItem(quality, totalValue) then
